...
(function(factory) {
	...
	$.fn.ajaxSubmit = function(options) {
		...
		// options.iframe allows system to force iframe mode
		...
		function fileUploadXhr(a) {
			...
			s.beforeSend = function(xhr, o) {
				//Send FormData() provided by system
				if (options.formData) {
		...
		function fileUploadIframe(a) {
			...
			function cb(e) {
				...
				try {
					...
					if (scr || s.textarea) {
						// see if system embedded response in textarea
	...
	*/
		...
		*/
			...
			*/
			...
			/**
		* Check if the system is scrolling instead of tapping.
		*
		* @param  {event} event
		*/

...
class CI_Cart {
	...
	function _insert($items = array())
	{
		...
		// Note: These can be system-specified by setting the $this->product_id_rules variable.
		...
		// Note: These can be system-specified by setting the $this->product_name_rules variable.
	 ...
	 * Typically it is called from the "view cart" page if a system makes

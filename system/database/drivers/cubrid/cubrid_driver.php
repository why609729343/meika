...
class CI_DB_cubrid_driver extends CI_DB {
	...
	// Default CUBRID Broker port. Will be used unless system
	...
	function db_connect()
	{
		// If no port is defined by the system, use the default value
		if ($this->port == '')
		{
		...
		if ($conn)
		{
			// Check if a system wants to run queries in dry, i.e. run the
	...
	function _escape_identifiers($item)
	{
		...
		foreach ($this->_reserved_identifiers as $id)
		{
			if (strpos($item, '.'.$id) !== FALSE)
			{
				...
				// remove duplicates if the system already included the escape
